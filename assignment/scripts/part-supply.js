...
console.log('Last item removed from supply changes:', removedChanges);
...
console.log('New delivery arrived. supplyChanges array is now:', supplyChanges);
...
for(changes of supplyChanges){
    console.log('for of loop', changes);
    if(changes>0){
